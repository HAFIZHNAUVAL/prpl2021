...
footer {
  ...
  <div id="background">
    <div class="jumbotron">
      <p >INDONESIA Adalah Negara Kepulauan Yang Terletak Di Asia Tenggara Yang Memiliki Sumber Daya Alam Yang Sangat Melimpah Dan Suku Budaya Yang Beragam.</p>
      <h1>INDONESIA</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="thumbnail"><img src="assets/img/gambar.jpg">
          <div class="caption">
            <h3>Gambar 1</h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="thumbnail"><img src="assets/img/gambar-2-e.jpg">
          <div class="caption">
            <h3>Gambar 2</h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="thumbnail"><img src="assets/img/gambar-2-f.jpg">
          <div class="caption">
            <h3>Gambar 3</h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="thumbnail"><img src="assets/img/gmbr.jpg">
          <div class="caption">
            <h3>Gambar 4</h3>
  ...
  <h1><center>Galeri</center></h1><br>
  <img src="gambar-1-d.jpg"><img src="gambar-2-g.jpg">
  <img src="gambar-3-g.jpg"><img src="gambar-3-C.jpg">
  <!-- container news -->
  <!-- gallery -->
  ...
  <!-- about -->
  <br><br>
  <section class="contact bg-light" id="social">
    <div class="container">
      <div class="row pt-4 mb-4">
        <div class="col text-center">
          ...
          <div class="row pt-4 mb-4">
            <h4>Youtube</h4>
            <div id="icon"><a><i class="fa fa-youtube-play">Hae <br><h5>2.000.000 Subscribers</h5></i></a></div>
          </div>
        </div>
        </div>
        <div class="row-center">
          <div class="col-center">
           <center> <div class="ratio ratio-20x20">
             <iframe src="https://www.youtube.com/embed/CBGBZzUr-Oo?rel=10" title="YouTube video" allowfullscreen></iframe>
           </div></center>
          </div>
        </div>
